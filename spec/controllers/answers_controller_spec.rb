...
describe AnswersController do
  ...
  describe "GET new" do
    it "assigns a new answer as @answer" do
      get :new, {question_id: question.id, answer: FactoryGirl.attributes_for(:answer)}, valid_session
  ...
  #       post :create, {:answer => { "name" => "invalid value" }}, valid_session
  #       assigns(:answer).should be_a_new(Answer)
  #     end
  ...
  #       Answer.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
  ...
  #       # Trigger the behavior that occurs when invalid params are submitted
  #       Answer.any_instance.stub(:save).and_return(false)
  #       put :update, {:id => answer.to_param, :answer => { "name" => "invalid value" }}, valid_session
  #       assigns(:answer).should eq(answer)
  #     end
